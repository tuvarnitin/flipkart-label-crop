...
const FlipcartCard = ({}) => {
  ...
  return (
      <div className="flex flex-col gap-3 items-center h-full border rounded-2xl px-4 pt-4">
          <h1 className="text-2xl font-bold text-slate-800 tracking-tight decoration-slate-400 select-none text-center">
              Flipkart Label Splitter
          </h1>

          <div className="w-full flex flex-col items-center justify-center text-center gap-3 rounded-xl bg-white p-5 shadow-md border border-slate-200">

              {/* Upload Box */}
              <label
                  className={`w-full h-26 flex flex-col items-center justify-center cursor-pointer rounded-lg border transition-all duration-200
